...
const char* WINDOWTITLE = { "OpenCL/OpenGL Particle System -- Susan Liu" };
const char* GLUITITLE = { "User Interface Window" };

// random parameters:					

//where the particls are located
const float XMIN = { -1200.0 };
...
Display()
{
	...
	{
		char str[128];
		sprintf(str, "%6.2f GigaSparks/Sec", (float)NUM_PARTICLES / ElapsedTime / 1000000000.);
...
InitLists()
{
	...
	// ****************************************
		...
		// do this for yourself...
			...
			//turquoise
			glColor3f(.1f, .6f, .8f);	// 0. <= r,g,b <= 1.
			glPushMatrix();
				glTranslatef(-100.f, -1200.f, 0.f);
				glutWireSphere(400.f, 100, 100);
			glPopMatrix();

			//glColor3f(1.f, .37f, .64f);	// 0. <= r,g,b <= 1.
			//glPushMatrix();
			//	glTranslatef(-100.f, -1600.f, 0.f);
			//	glutWireSphere(200.f, 100, 100);
			//glPopMatrix();


			//teal
			glColor3f(0.f, 1.f, 0.f);	// 0. <= r,g,b <= 1.
			glPushMatrix();
				glTranslatef(900.f, -800.f, 0.f);
				glutWireSphere(200.f, 100, 100);
			glPopMatrix();

			//blue
			glColor3f(1.f, 1.f, 1.f);	// 0. <= r,g,b <= 1.
			glPushMatrix();
				glTranslatef(900.f, -1200.f, 0.f);
				glutWireSphere(400.f, 100, 100);
			glPopMatrix();

			//glColor3f(1.f, 1.f, 1.f);	// 0. <= r,g,b <= 1.
			//glPushMatrix();
			//	glTranslatef(900.f, -1600.f, 0.f);
			//	glutWireSphere(200.f, 100, 100);
			//glPopMatrix();

			//gold
			glColor3f(.86f, .57f, 0.f);	// 0. <= r,g,b <= 1.
			glPushMatrix();
			...
			//navy
			glColor3f(0.f, 0.f, .5f);	// 0. <= r,g,b <= 1.
			glPushMatrix();
				glTranslatef(-1000.f, -1200.f, 0.f);
				glutWireSphere(400.f, 100, 100);
			glPopMatrix();

			//glColor3f(0.f, 0.f, .5f);	// 0. <= r,g,b <= 1.
			//glPushMatrix();
			//	glTranslatef(-1000.f, -1600.f, 0.f);
			//	glutWireSphere(200.f, 100, 100);
			//glPopMatrix();

			/*//teal
			glColor3f(.8f, 1.f, .8f);	// 0. <= r,g,b <= 1.
			glPushMatrix();
				glTranslatef(-100.f, -800.f, 0.f);
				glRotatef(90, 1, 0, 0);
				glutWireTorus(100.f, 400.f, 10.f, 100);
			glPopMatrix();

			//orange
			glColor3f(.8f, .6f, .2f);	// 0. <= r,g,b <= 1.
			glPushMatrix();
				glTranslatef(-100.f, -1400.f, 0.f);
				glRotatef(90, 1, 0, 0);
				glutWireCone(400.f, 900.f, 10.f, 10.);
			glPopMatrix();*/
